        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <button id="playMusicButton" class="btn btn-outline-custom">Ya, putar musik</button>
                    <button id="closeMusicModal" class="btn btn-outline-custom" data-bs-dismiss="modal">Tidak, terima
                        kasih</button>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="hero-wrapper"
            ...
            <div id="home" class="hero section text-center text-white d-flex align-items-center"
                style="height: 470px;">
                <div id="hero-text" style="padding-top: 180px; padding-left:13px;">
                ...
                <div
                    style="position: absolute; top: 62%; left: 50%; transform: translate(-50%, -50%); z-index: 0; padding-top: 350px;">
            ...
            <section class="section py-5" id="about">
                ...
                <div
                    style="position: absolute; left: 50%; transform: translate(-50%, -50%); z-index: 0; padding-top: 170px;">
                    <img src="{{ asset('images/elemen.png') }}" alt="Elemen">
                </div>
            </section>
            ...
            <div id="invitation" class="section" style="padding: 100px 0;">
                ...
                <div
                    style="position: absolute; left: 50%; transform: translate(-50%, -50%); z-index: 0; padding-top: 140px;">
                    <img src="{{ asset('images/elemen.png') }}" alt="Elemen">
                </div>
            </div>
                    ...
                    <div class="row" style="height:50rem;">
                        ...
                        <div class="col-6">
                            ...
                            <div class="col-sm-12" style="padding-left: 40px">
                                <p class="tulisan3 animated" data-animation="fadeInLeft">
            ...
            <div id="gallery" class="section" style="padding: 100px; padding-top:0;">
                <div class="container">
                    <h2 class="ourmovies"
